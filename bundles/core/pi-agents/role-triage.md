...
If the knowledge-base capability is available, follow the **Post-Session Persistence** pattern in `memory-substrate` using `source_agent="triage"`. Capture routing patterns and label conventions for the project.
